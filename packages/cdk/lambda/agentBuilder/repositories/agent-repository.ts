...
export const createAgent = async (
  ...
  const item: AgentInTable = {
    ...
    browserEnabled: content.browserEnabled ?? false,
    tags: content.tags || [],
...
export const updateAgent = async (
  ...
  await dynamoDbDocument.send(
    new UpdateCommand({
      ...
      UpdateExpression:
        'set #name = :name, description = :description, systemPrompt = :systemPrompt, modelId = :modelId, mcpServers = :mcpServers, codeExecutionEnabled = :codeExecutionEnabled, browserEnabled = :browserEnabled, tags = :tags, isPublic = :isPublic, updatedAt = :updatedAt, createdByEmail = :createdByEmail',
