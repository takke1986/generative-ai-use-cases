...
export async function createAgent(
  ...
  const agent = await agentRepository.createAgent(userId, {
    ...
    browserEnabled: request.browserEnabled ?? false,
  ...
  try {
    await agentRepository.updateAgent(userId, agentId, {
      ...
      codeExecutionEnabled:
        ...
        false,
      browserEnabled:
        request.browserEnabled ?? existingAgent.browserEnabled ?? false,
      tags:
        request.tags
          ?.map((tag) => tag.trim())
...
export async function cloneAgent(
  ...
  const newAgent = await agentRepository.createAgent(userId, {
    ...
    browserEnabled: sourceAgent.browserEnabled || false,
  ...
  return {
    ...
    browserEnabled: newAgent.browserEnabled,
    tags: newAgent.tags,
